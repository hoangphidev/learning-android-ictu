...
import ictu.oanhninh.ezquiz.QuizContract.*;
...
public class QuizDbHelper extends SQLiteOpenHelper {
    ...
    private void fillQuestionsTable() {
        Question q1 = new Question("Easy: A là đáp án đúng", "A", "B", "C", 1, Question.DIFFICULTY_EASY);
        addQuestion(q1);
        Question q2 = new Question("Medium: B là đáp án đúng", "A", "B", "C", 2, Question.DIFFICULTY_MEDIUM);
        addQuestion(q2);
        Question q3 = new Question("Medium: C là đáp án đúng", "A", "B", "C", 3, Question.DIFFICULTY_MEDIUM);
        addQuestion(q3);
        Question q4 = new Question("Hard: A là đáp án đúng", "A", "B", "C", 1, Question.DIFFICULTY_HARD);
        addQuestion(q4);
        Question q5 = new Question("Hard: B là đáp án đúng", "A", "B", "C", 2, Question.DIFFICULTY_HARD);
        addQuestion(q5);
        Question q6 = new Question("Hard: C là đáp án đúng", "A", "B", "C", 3, Question.DIFFICULTY_HARD);
        addQuestion(q6);
    }
